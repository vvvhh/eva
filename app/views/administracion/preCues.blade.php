  ...
  <div class="col-md-10">
    ...
    <form class="form-horizontal" id="form" name="form" novalidate>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input id="txtTema" name="txtSubTema" type="text" class="form-control grisObscuro" pattern="[ñÑZáéíóúñÁÉÍÓÚ  \d\w\s@._-]+"  placeholder="*SubTema de donde se obtendrá la información" required>
          <p class="text-danger formatoTexto14" id="spnNombre"> </p>
          <input type="hidden" name="token" id="token" value="<?php echo csrf_token(); ?>">
        </div>
      </div>
