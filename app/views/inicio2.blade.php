    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul id="myTab" class="nav nav-tabs nav-justified">
            <li class="active"><a href="#service-one" data-toggle="tab"><i class="fa fa-pencil-square"></i> Ingresar cuestionario:</a>
            </li>
            <li class=""><a href="#service-two" data-toggle="tab"><i class="fa fa-newspaper-o"></i> Cuestionario ingresado:</a>
            </li>
        </ul>
