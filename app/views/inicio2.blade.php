      ...
      <label for="txtNombreS" class=" control-label">¿Qué tipo de pregunta deseas capturar? </label>
        <div class="form-group">
          <div class="col-md-8">
            <p class="text-danger formatoTexto14" id="spnNombre"> </p>
            <input type="hidden" name="token" id="token" value="<?php echo csrf_token(); ?>">
            <input id="chkAbierta" type="checkbox" name="transporte"  value="1" onClick="chk()">  Abierta 
            <br>
            <input id="chkOpMul" type="checkbox" name="transporte" value="1" onClick="chk()">  Opción múltiple
          </div>
        </div>
    </div>
